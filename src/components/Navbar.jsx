...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav
        className={`absolute top-0 left-0 right-0 z-50 flex items-center justify-between px-[6%] py-7 transition-all duration-300 ${
          scrolled ? 'bg-[#050a05]/80 backdrop-blur-md shadow-[0_1px_0_rgba(255,255,255,0.05)]' : ''
        }`}
      >
        {/* Logo */}
        <a href="#" onClick={() => handleLinkClick('#')} className="flex items-center hover:opacity-90 transition-opacity shrink-0">
          <img
            src="/logo.png"
            alt="Jungle Beach Camp"
            className="h-12 w-auto object-contain drop-shadow-md rounded-full"
          />
        </a>
