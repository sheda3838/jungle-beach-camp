...
const inputBase =
  'w-full rounded-xl px-4 py-3 font-sans text-[14px] text-[#f5ead4] placeholder-[#f5ead4]/25 outline-none transition-all duration-300 focus:ring-2';
const inputNormal =
  'bg-white/[0.05] border border-white/[0.08] focus:border-[#f0a850]/50 focus:ring-[#f0a850]/15';
const inputError =
  'bg-red-500/[0.07] border border-red-400/50 focus:border-red-400/70 focus:ring-red-400/10';
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-14 py-10 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="flex flex-col gap-8">
            ...
            >
              Reach out to us for bookings, inquiries, or special requests. Whether it's a
              peaceful beach stay, camping experience, or group adventure — we're here to help
              you plan it.
            </motion.p>
            ...
            >
              ...
              <span className="font-sans text-[11px] text-white/25 tracking-widest uppercase">
                Jungle Beach Camp
              </span>
              <span className="w-16 h-[1px] bg-white/10" />
            </motion.div>
              ...
              <AnimatePresence mode="wait">
                ...
                {status === 'success' ? (
                  ...
                  >
                    ...
                    <div>
                      <h3 className="font-serif text-2xl font-bold text-[#f5ead4] mb-2">
                        Message Received!
                      </h3>
                  ...
                  >
                    ...
                    <div className="mb-1">
                      ...
                      <p className="font-sans text-[13px] text-[#f5ead4]/40 font-light">
                    ...
                    <button
                      ...
                      style={{
                        background: 'linear-gradient(135deg, #f0a850 0%, #c87941 100%)',
                        boxShadow: '0 6px 24px rgba(240,168,80,0.25)',
                      }}
                    >
                      <AnimatePresence mode="wait">
                        {status === 'loading' ? (
